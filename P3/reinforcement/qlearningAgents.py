...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.qValues[(state, action)] = q + a * (reward + g * qPrime - q)
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for key in allFeatures.keys():
          qValue += allFeatures[key] * self.weights[key]
        return qValue
    ...
    def update(self, state, action, nextState, reward):
        ...
        diff = (reward + g * qPrime) - qValue

        for feature in allFeatures.keys():
          self.weights[feature] += a * diff * allFeatures[feature]
